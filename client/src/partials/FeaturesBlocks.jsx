      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 mb-4">Majority of  people do not know where to buy or sell second hand goods.</h2>
            <p className="text-xl text-gray-400">Are you having problems in trying to find out where to sell or buy second 
            hand goods? Well you came to the right place. Market De Black is a public verified cooporation that
            facilitates secure and convenient way to buy or sell second hand goods. We offer the best Escrow. Do not be left out join us now and enjoy a welcome free first transaction</p>
          </div>
